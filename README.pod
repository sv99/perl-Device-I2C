...
Writing your own chipset driver for your own i2c devices is quiet simple. You just need to know the i2c address of your device and the registers that you need to read or write. Follow the manual at L<Device::I2C::Manual>.
...
L<https://github.com/shantanubhadoria/perl-device-i2c/issues>.
...
L<https://github.com/shantanubhadoria/perl-device-i2c>
